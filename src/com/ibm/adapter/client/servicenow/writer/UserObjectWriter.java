package com.ibm.adapter.client.servicenow.writer;
...
/**
 * MessageBoxWriter for ServiceNow user object Which write java object to json
 * object.
 * 
 * @author Kyawkm
 *
...
public class UserObjectWriter implements MessageBodyWriter<User> {
	...
	public void writeTo(User user, Class<?> arg1, Type arg2, Annotation[] arg3, MediaType arg4,
		...
		gen.writeStartObject().write("name", user.getUsername());
		if (user.getEmail() != null)
			gen.write("email", user.getEmail());
		if (user.getUsername() != null)
			gen.write("user_name", user.getUsername());
		if (user.getPassword() != null)
			gen.write("user_password", user.getPassword());
